...
public:
    ...
    explicit Item(std::unique_ptr<std::string> str)
        :str(std::move(str))
    {
    ...
    Item(const Item& other)
            : str(std::make_unique<std::string>(*other.str))
    {
    }
...
//int main()
//{
//    std::unique_ptr<std::string> str = std::make_unique<std::string>("test");
//    Item item1(std::move(str)); // Create the first Item object
//}
    ...
    if (inputFile.is_open())
    {
        while (std::getline(inputFile, str))
        {
            ...
            if (tokens[0] == "Circle")
            {
                ...
                std::cout << std::stof(tokens[9]) << std::endl;
                std::cout << std::stoi(tokens[6]) << ", " << std::stoi(tokens[7]) << ", " << std::stoi(tokens[8]) << std::endl;
                std::cout << std::stof(tokens[4]) << ", " << std::stof(tokens[5]) << std::endl;
                std::cout << std::stof(tokens[2]) << ", " << std::stof(tokens[3]) << std::endl;
